      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {error && (
          <p className="text-sm text-amber-600 mb-4">
            Could not load packages. Make sure the backend is running and VITE_BASE_URL is set.
          </p>
        )}

        {!error && packages.length === 0 && (
          <p className="text-sm text-gray-500 mb-4">
            No packages yet. Add packages in Admin (Manage Packages) or run the seed script:{" "}
            <code className="text-xs bg-gray-100 px-1 rounded">node Backend/dev-data/seedPackages.js</code>
          </p>
        )}
