...
<div aria-hidden="true" className="absolute inset-0 hidden sm:flex sm:flex-col min-h-[700px]"> <div className="relative w-full flex-1 bg-gray-800"> <div className="absolute inset-0 overflow-hidden"> <img
           alt=""
           src="background-image-minoxidil.jpeg"
           className="w-full h-full object-cover"
         /> </div> <div className="absolute inset-0 bg-gray-900 opacity-50" /> </div> <div className="h-32 w-full bg-white md:h-40 lg:h-48" /> </div>
  ...
  <section aria-labelledby="collection-heading" className="relative  -mt-64 sm:mt-0">
