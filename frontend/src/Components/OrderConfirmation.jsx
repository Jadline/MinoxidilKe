      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <p className="mt-2 text-base text-gray-500">
              Your order <span className="font-medium text-green-500">{latestOrder.orderNumber}</span> has shipped and will be with you soon. 
              You will also receive an email at <span className="font-medium text-indigo-500">{latestOrder.email}</span> when your product arrives.
            </p>

          <dl className="mt-12 text-sm font-medium">
            <dt className="text-gray-900">Tracking number</dt>
            <dd className="mt-2 text-indigo-600">{latestOrder.trackingNumber}</dd>
          </dl>
        </div>
                ...
                <div className="mt-6 flex flex-1 items-end">
                  <dl className="flex divide-x divide-gray-200 text-sm">
                    ...
                    <div className="flex pl-4 sm:pl-6">
                      ...
                      <dd className="ml-2 text-gray-700">{product.price * product.quantity}</dd>
                    </div>
                  </dl>
                </div>
              </div>
              ...
              <div>
                ...
                <dd className="mt-2 text-gray-700">
                  ...
                  <p>
                    ...
                    {paymentMethod === 'credit-card' && `TransactionId: ${payinfo}`}
