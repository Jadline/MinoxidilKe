  ...
  {new Date(order.date).toLocaleDateString(undefined, {
    ...
    day: 'numeric',
                  ...
                  <div className="mb-2 sm:mb-0">
                    ...
                    <dd className="text-sm text-gray-600">{order.orderNumber}</dd>
                  </div>
                  <div>
                    <dt className="font-medium text-gray-900">Total amount</dt>
                    <dd className="text-sm text-gray-600">{order.OrderTotal}</dd>
                  </div>
                </div>
              ...
              <div className="overflow-x-auto mt-4 rounded-lg border border-gray-200">
                <table className="min-w-full divide-y divide-gray-200 text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      <th scope="col" className="py-3 px-4 text-left">Product</th>
                      <th scope="col" className="py-3 px-4 text-left">Quantity</th>
                      <th scope="col" className="py-3 px-4 text-left">Price</th>
                      <th scope="col" className="py-3 px-4 text-left">Shipping</th>
                    ...
                    {order.orderItems.map((product) => (
                      <tr key={product.id}>
                        <td className="py-4 px-4 flex items-center space-x-4">
                          ...
                          />
                          <span className="font-medium text-gray-900 text-left">{product.name}</span>
                        </td>
