...
const navigation = {
  ...
  social: [
    {
      name: "Instagram",
      href: "https://www.instagram.com/hair_solution_kenya?igsh=bmU1cDY0aTQ0MzZ5",
      icon: (props) => (
    ...
    {
      name: "TikTok",
      href: "https://www.tiktok.com/@minoxidil_ke?_r=1&_t=ZS-93briGfWcgj",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: "WhatsApp",
      href: "https://wa.me/c/254726787330",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
